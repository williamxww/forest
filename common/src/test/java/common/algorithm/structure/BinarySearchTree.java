 ...
 * <p>
 * 
 * @see <a href="https://en.wikipedia.org/wiki/Binary_search_tree">Binary Search
 *      Tree (Wikipedia)</a> <br>
...
public class BinarySearchTree<T extends Comparable<T>> implements ITree<T> {
     ...
     * @return nodeRemove Node<T> removed from the tree, it can be different
     ...
     *        should NOT be NULL.
     * @param replacementNode Node<T> to replace nodeToRemoved in the tree.
     *        replacementNode can be NULL.
     */
